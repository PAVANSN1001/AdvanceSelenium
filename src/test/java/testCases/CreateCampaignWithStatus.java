...
public class CreateCampaignWithStatus {
	...
	public static void main(String[] args) throws EncryptedDocumentException, IOException {
		...
		//excel
		//FileInputStream fis2= new FileInputStream(".\\src\\test\\resources\\TestScriptData.xlsx");
		//Workbook wb2 = WorkbookFactory.create(fis1);
		//Sheet sh2 = wb2.getSheet("Campaign");
		//Row r2=sh2.getRow(1);
		//String prodname = r2.getCell(0).getStringCellValue();
		//String Quantity = r2.getCell(1).getStringCellValue();
		//String Price = r2.getCell(2).getStringCellValue();
		...
		//create campaign
				...
				target1.clear();
				target1.sendKeys("10");
				driver.findElement(By.name("campaignStatus")).sendKeys("fastandfurious");
